...
%{
    ...
    My results were identical to Matlabs eps, the built in value of me, so my method seems to work well.  Also, knowing that our base is 2 and seeing that precision is estimated to be 53, we can check that 2^-52 = output = b^1-p as desired.
%}